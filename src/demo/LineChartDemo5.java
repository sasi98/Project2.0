...
public class LineChartDemo5 extends ApplicationFrame {
    ...
    private static JFreeChart createChart(CategoryDataset categorydataset) {
        JFreeChart jfreechart = ChartFactory.createLineChart("Line Chart Demo 5", "Type", "Value", categorydataset, PlotOrientation.VERTICAL, true,
                true, false);
        ...
        DefaultDrawingSupplier defaultdrawingsupplier = new DefaultDrawingSupplier(DefaultDrawingSupplier.DEFAULT_PAINT_SEQUENCE,
                ...
                DefaultDrawingSupplier.DEFAULT_OUTLINE_STROKE_SEQUENCE, ashape);
