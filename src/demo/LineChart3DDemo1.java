...
public class LineChart3DDemo1 extends ApplicationFrame {
    ...
    public LineChart3DDemo1(final String s) {
        super(s);
    ...
    private static JFreeChart createChart(final CategoryDataset categorydataset) {
        final JFreeChart jfreechart = ChartFactory.createLineChart3D("Line Chart 3D Demo 1", null, "Class Count", categorydataset,
    ...
    public static void main(final String args[]) {
        final LineChart3DDemo1 linechart3ddemo1 = new LineChart3DDemo1("JFreeChart: LineChart3DDemo1.java");
