...
public class Company {
	...
	private String id;
	private String name;
	private int quoteDays; //N�mero de dias de cotizaci�n, no cuenta con el 11 de octubre para los que no tenemos rm ni ri
							//n� que aparece en la hoja menos 1
	...
	public void printCompany (){
		...
		log.trace("N� quote days: " + this.quoteDays + "/n");
		System.out.println("Id: " + this.id + "/n");
		System.out.println("Name: " + this.name + "/n");
		System.out.println("N� quote days: " + this.quoteDays + "/n");
		for(Date d: dates)
		{
