...
/**
 * Clase Matrix
 * Clase que define objetos Matrix simples para realizar operaciones b�sicas sobre matrices y vectores. 
 * 
*/
public class Matrix {
...
/**
 * A�adir valor en posicion [r][c]
 * @param r �ndice de fila
 * @param c �ndice de columna
 * @param value Valor a a�adir a la matriz
*/
...
/**
 * Obtener valor en posici�n[f][c]
 * @param f �ndice fila
 * @param c �ndice columna
...
/**
 * Transponer matriz. Transpone la matriz entrada por par�metro
 * @param m
 * @return m' 
*/
...
public static Matrix product (Matrix mA, Matrix mB){
	...
	if (mA.getColumn() != mB.getRow()){
		log.error("El n�mero de columnas de mA es distinto al n�mero de filas de mB, por lo que las matrices no se pueden multiplicar");
...
/**
 * Obtiene la matrix correspondiente al n� de columna pasado por par�metro 
 * @param index �ndice de la columna a obtener
...
/**
 * Obtiene el vector correspondiente al n� de columna pasado por par�metro 
 * @param index �ndice de la columna a obtener
...
/**
 * Obtiene el vector correspondiente al n� de fila pasado por par�metro 
 * @param index �ndice de la fila a obtener
 ...
 * @param precision N� m�ximo de decimales que puede tener nuestros valores
 * @post La matriz de la clase est� ahora truncada y redondeada a la alza
*/
...
//Genera una matrix (filas = n� de arrays, columnas = tama�o de los arrays) a partir 
//del array de arrays introducido por par�metros.
