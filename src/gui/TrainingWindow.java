...
public class TrainingWindow {
    ...
    public void initialize() {
        ...
        for (final NetworkManager ne : MainWindow.neList) { //A�adimos las instancias creadas al ComBox
    ...
    private void btnIniciarEntrenamientoActionPerformed() {
        ...
        if (rdbtnSi.isSelected()) { //Entrenamiento con momento Beta a�adido en la actualizaci�n de matriz
            momentB = true;
        }
